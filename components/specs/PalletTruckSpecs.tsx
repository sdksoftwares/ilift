...
interface ProductProps {
    product: {
        ...
        sub_category_pallet_truck?: string
    }
}

export default function PalletTruckSpecs({ product }: ProductProps) {
    const specs = product.specifications || {}
    const subType = product.sub_category_pallet_truck?.replace('pallet_truck_', '').replace(/_/g, ' ').toUpperCase() || 'STANDARD'
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-4 pb-4 border-b border-slate-200">
                ...
                <div>
                    <h3 className="text-xl font-bold text-slate-900 uppercase">Pallet Truck Specifications</h3>
